/*
  SensoresRB.h - Biblioteca para el uso de los sensores de RoverBot.
...
#ifndef SensoresRB_h // Evita problemas si alguien importa dos veces
#define SensoresRB_h // Evita problemas si alguien importa dos veces
